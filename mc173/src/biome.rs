...
impl Biome {
    ...
    pub fn has_rain(self) -> bool {
        !matches!(
            self,
            Biome::Desert | Biome::IceDesert | Biome::Nether | Biome::Sky
        )
    }
    ...
    pub fn has_snow(self) -> bool {
        matches!(self, Biome::Taiga | Biome::IceDesert | Biome::Tundra)
    }
    ...
    pub fn natural_entity_kinds(self, category: EntityCategory) -> &'static [NaturalEntityKind] {
        ...
        match self {
            ...
            Biome::Nether => match category {
                EntityCategory::Mob => NETHER_MOBS,
                _ => &[],
            },
            Biome::Sky => match category {
