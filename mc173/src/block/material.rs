...
pub fn get_material(block: u8) -> Material {
    match block {
        ...
        block::STICKY_PISTON | block::PISTON | block::PISTON_EXT | block::PISTON_MOVING => {
            Material::Piston
        }
        block::COBWEB => Material::Cobweb,
        block::GOLD_BLOCK | block::IRON_BLOCK | block::DIAMOND_BLOCK | block::IRON_DOOR => {
            Material::Iron
        }
...
pub fn is_fluid_proof(block: u8) -> bool {
    match block {
        block::AIR => false,
        block::WOOD_DOOR | block::IRON_DOOR | block::SIGN | block::LADDER | block::SUGAR_CANES => {
            true
        }
...
pub fn get_break_hardness(id: u8) -> f32 {
    match id {
        ...
        | block::SOULSAND
        | block::CAKE => 0.5,
        block::GRASS | block::GRAVEL | block::SPONGE | block::FARMLAND | block::CLAY => 0.6,
        block::POWERED_RAIL | block::DETECTOR_RAIL | block::RAIL => 0.7,
        block::SANDSTONE | block::NOTE_BLOCK | block::WOOL => 0.8,
        block::SIGN | block::WALL_SIGN | block::PUMPKIN | block::PUMPKIN_LIT => 1.0,
        ...
        block::COBWEB => 4.0,
        block::IRON_BLOCK | block::DIAMOND_BLOCK | block::IRON_DOOR | block::SPAWNER => 5.0,
        block::OBSIDIAN => 10.0,
        block::BEDROCK
        | block::PISTON_MOVING
        | block::PORTAL
...
pub fn get_piston_policy(id: u8, metadata: u8) -> PistonPolicy {
    match id {
        ...
        _ => match get_material(id) {
            ...
            Material::Portal | Material::Piston => unreachable!(),
...
impl Material {
    ...
    pub fn is_translucent(self) -> bool {
        matches!(
            self,
            Self::Leaves | Self::Glass | Self::Tnt | Self::Ice | Self::Snow | Self::Cactus
        )
    }
    ...
    pub fn is_breakable_by_default(self) -> bool {
        !matches!(
            self,
            Self::Rock | Self::Iron | Self::Snow | Self::SnowBlock | Self::Cobweb
        )
    }
}
